...
id`,
`categoryName
`, `categoryDescription`, `creationDate`, `updationDate`) VALUES
...
id`,
`stateName
`, `stateDescription`, `postingDate`, `updationDate`) VALUES
...
id`,
`categoryid
`, `subcategory`, `creationDate`, `updationDate`) VALUES
...
`category`,
`subcategory
`, `complaintType`, `state`, `noc`, `complaintDetails`, `complaintFile`, `regDate`, `status`, `lastUpdationDate`) VALUES
...
id`,
`uid
`, `username`, `userip`, `loginTime`, `logout`, `status`) VALUES
...
`password`,
`contactNo
`, `address`, `State`, `country`, `pincode`, `userImage`, `regDate`, `updationDate`, `status`) VALUES
